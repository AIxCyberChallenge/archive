...
<main>
    <div class="container">
        <div class="sherpa-content" >
            ...
            <p class="mb-2">Interact with, explore, and reason over the a small subset of the competition results and telemetry using DuckDB-Wasm. The sample dataset contains ~20K records of the 400M records in CRUMBS. For details on interacting with the full dataset, check out the <a href="/data/getting_started/">getting started page</a> </p>
        </div>

        <div class="main-content">
            <div id="sidebar" class="sidebar">
                <div id="sidebar-header" class="sidebar-header flex">
                    <div id="sb-header-text" class="flex">
                        <h2>Sample CRUMBS Data</h2>
                    </div>
                    <div class="flex">
    ...
    <script>
        ...
        const sidebar_header_text = document.getElementById("sb-header-text");

        toggleBtn.addEventListener("click", () => {
            sidebar.classList.toggle("hidden");
            sidebar_header_text.classList.toggle("collapsed");
            sidebar_header_text.classList.toggle("flex");
            sidebar_content.classList.toggle("collapsed");
